      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="p-2.5 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-2xl border border-transparent hover:border-slate-100 active:scale-95 transition-all duration-150"
            title="Cerrar Sesión"
          >
